	...
	<div class="container">
		<div class="content">
			<form id="form" action="GetInformation" method="post">
				...
				<div class="form-group">
					<label>Enter maximum distance of search(km): </label>
					<input type="text" id="maximum_search_distance" name="maximum_search_distance" class="form-control" placeholder="Enter maximum distance of searche" required>
				</div>
